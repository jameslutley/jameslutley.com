export const theme = {
  ...
  Mobile: `@media (min-width: 25em)`,
  phablet: `(min-width: 34em)`,
  Phablet: `@media (min-width: 34em)`,
  tablet: `(min-width: 48em)`,
  Tablet: `@media (min-width: 48em)`,
  desktop: `(min-width: 64em)`,
  Desktop: `@media (min-width: 64em)`,
  hd: `(min-width: 75em)`,
  Hd: `@media (min-width: 75em)`,
  VHd: `@media (min-width: 90em)`,
  VVHd: `@media (min-width: 100em)`,
